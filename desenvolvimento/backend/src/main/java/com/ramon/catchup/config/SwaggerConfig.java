...
public class SwaggerConfig {
    ...
    private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.title("Api-catchup");
		apiInfoBuilder.description("Api para realização de uma rede social entre os funcionarios do grupo Mateus.");
		apiInfoBuilder.version("1.0");
		apiInfoBuilder.termsOfServiceUrl("Termo de uso: Foi utilizado para um teste de emprego.");
